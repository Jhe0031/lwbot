module.exports.run = async (client, message, args) => {
    ...
    await message.author.send("** **");
    await message.author.send("**Step 2:** Click on the button next to the subscribe button (it's two curved lines and a dot). Copy the URL you see at the top. This is your RSS link to paste into lw-wa.", {files: ['./rsshelp-media/step2.gif']});
};